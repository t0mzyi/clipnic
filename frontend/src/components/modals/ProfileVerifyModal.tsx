                ...
                {step === 1 ? (
                    <div className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-white/40">Connect your Discord to access missions.</p>
                        </div>
                        ...
                        {user?.discordVerified && (
                             <button onClick={() => setStep(2)} className="w-full text-[10px] text-white/30 uppercase tracking-[0.2em] hover:text-white transition-colors">Skip to Socials</button>
                        )}
                    </div>
                ) : (
                    <div className="space-y-6">
