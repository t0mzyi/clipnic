        ...
        >
                    ...
                    <div className="space-y-3 text-left">
                        {isComingSoon ? (
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/10 backdrop-blur-md border border-amber-500/20 text-amber-500 text-[10px] font-bold uppercase tracking-wider shadow-lg">
                                ...
                                Starting {new Date(campaign.start_date!).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}
                            </div>
                        ) : (
                                ...
                                {isComingSoon ? (
                                    <div className="flex flex-col items-center gap-0.5">
                                        ...
                                        <span className="text-[9px] sm:text-[10px] opacity-40 normal-case tracking-tight font-medium">
                                            {new Date(campaign.start_date!).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}
                                        </span>
                                    </div>
                                ) : (
                                    <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="p-5 rounded-2xl bg-[#0c0c0c] border border-white/[0.06] space-y-2">
                    ...
                    <p className="text-xl font-mono font-bold text-blue-400">{campaign.start_date ? new Date(campaign.start_date).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'medium', timeStyle: 'short' }) : 'Immediate'}</p>
                ...
                <div className="p-5 rounded-2xl bg-[#0c0c0c] border border-white/[0.06] space-y-2">
                    ...
                    <p className="text-xl font-mono font-bold text-amber-400">{new Date(campaign.end_date).toLocaleString('en-IN', { timeZone: 'Asia/Kolkata', dateStyle: 'medium', timeStyle: 'short' })}</p>
