...
import { Shield, Eye, DollarSign, Clock, Target, Upload, ChevronLeft, X, CheckCircle, Globe, Trophy, Award, Medal } from 'lucide-react';
                                                    ...
                                                    <div className="space-y-3">
                                                        ...
                                                        <Dropdown
                                                            ...
                                                            options={[
                                                                ...
                                                                ...(campaign.allowed_platforms?.includes('youtube') && user?.youtubeVerified ? (user?.youtubeChannels?.map((c: any) => c.handle || c.channelId) || (user?.youtubeHandle ? [user.youtubeHandle] : ['Verified YouTube Account'])).map((h: string) => ({
                                                                    label: h,
                                                                    value: h,
