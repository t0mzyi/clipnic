                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="min-w-0">
                                                        <p className="text-sm font-medium text-white/90 truncate">{(!user.name || user.name === 'Anonymous' || user.name === 'Anonymous Clipper' || user.name === 'Anonymous user') ? 'null' : user.name}</p>
